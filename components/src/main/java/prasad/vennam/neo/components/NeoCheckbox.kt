...
@Preview(name = "NeoCheckbox Preview - Checked & Unchecked")
@Composable
private fun NeoCheckboxPreview() {
    NeoTheme {
        Row(
            ...
            Text("Checked", style = NeoTheme.typography.body, color = NeoTheme.colors.textPrimary)

            Spacer(Modifier.width(16.dp))

            NeoCheckbox(checked = false, onCheckedChange = {})
            Spacer(Modifier.width(8.dp))
            Text("Unchecked", style = NeoTheme.typography.body, color = NeoTheme.colors.textPrimary)
        }
    }
}
